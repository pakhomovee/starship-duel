...
const STR = {
  ...
  "desc.UNLOCK_JAMMING": ["Permanent unlock: your Energy-spending actions show to the rival only as a generic “spent Energy”, and it blinds their Proximity Alert.",
    "Постоянное улучшение: ваши энергозатратные действия видны сопернику только как безликое «потратил энергию», а его датчик сближения слепнет."],
  ...
  "p.f_lastact": ["The action they last took publicly — masked to a generic value if they run Jamming.",
    "Их последнее публичное действие — замаскировано до общего значения, если у них глушение."],
  ...
  "r.jam_p": ["Your Energy actions show to the rival only as a generic <b>“spent Energy”</b>.",
    "Ваши энергозатратные действия видны сопернику только как безликое <b>«потратил энергию»</b>."],
  ...
  "r.jam_quote": ["“spent Energy”", "«потратил энергию»"],
